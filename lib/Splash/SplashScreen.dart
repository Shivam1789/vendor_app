...
class _SplashScreenState extends State<SplashScreen>
  ...
  Widget get _getLogoImage {
    ...
    return new SizedBox(
      ...
      /*new Image.asset(
        AssetStrings.splashImage2,
        fit: BoxFit.fill,
        height: getScreenSize(context: context).width * 0.41,
        width: getScreenSize(context: context).width * 0.48,
      ),*/
    );
  }
...
//  loadUser() {
//    User user = MemoryManagement.getUserInfo();
//    LoggedInUser.setUser = user;
//  }
//  getLocale(context){
//    Locale myLocale = ui.window.locale;//Localizations.localeOf(context);
//    print("Country Code= ${myLocale.countryCode}");
//    print("Lang code= ${myLocale..languageCode}");
//    String countryCode= myLocale.countryCode;
//    CommonData.defaultCountryCode=countryCode;
//
//  }
}
