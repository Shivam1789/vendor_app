...
class CustomStepper{
  ...
  static Widget getStepper(List value){
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: Row(
        children: <Widget>[
          Icon(Icons.account_circle,color: const Color(0xFFFA7268),size: 30,),
          Expanded(
              child: CustomProgressBar(
                direction: Axis.horizontal,
                currentValue: value.isEmpty ? 0 : 100,
              )
          ),
          Icon(Icons.add_circle,color: const Color(0xFFFA7268),size: 30,),
          Expanded(
              child: CustomProgressBar(
                direction: Axis.horizontal,
                currentValue: value.isEmpty ? 0 : 100,
...
class CustomProgressBar extends StatefulWidget {
  CustomProgressBar(
      {Key key,
        ...
        this.maxValue = 100,
        this.size = 5,
        this.animatedDuration = const Duration(seconds: 2),
